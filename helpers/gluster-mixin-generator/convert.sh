...
GLUSTER_MIXIN_PROMEHTEUS_RULES_ROOT=$OUT_CONVERTED_ROOT/monitoring-prometheus-operator.deploy/app/config/prometheus/rules/gluster-mixin
...
GLUSTER_MIXIN_GRAFANA_DASHBOARD_ROOT=$OUT_CONVERTED_ROOT/monitoring-grafana.deploy/app/config/dashboards/gluster-mixin
