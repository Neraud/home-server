...
ssh 192.168.100.10 "lvremove -y --force /dev/data_vg/gluster_openldap-config"
ssh 192.168.100.10 "lvremove -y --force /dev/data_vg/gluster_openldap-data"
ssh 192.168.100.10 "lvremove -y --force /dev/data_vg/gluster_openldap-run"
