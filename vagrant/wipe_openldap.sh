...
ssh 192.168.100.13 "umount /data/glusterfs/openldap-config/brick1"
ssh 192.168.100.13 "umount /data/glusterfs/openldap-data/brick1"
ssh 192.168.100.13 "umount /data/glusterfs/openldap-run/brick1"

echo ""
echo "Deleting OpenLDAP lvs"
ssh 192.168.100.11 "lvremove -y --force /dev/data_vg/gluster_openldap-config"
ssh 192.168.100.11 "lvremove -y --force /dev/data_vg/gluster_openldap-data"
ssh 192.168.100.11 "lvremove -y --force /dev/data_vg/gluster_openldap-run"
ssh 192.168.100.12 "lvremove -y --force /dev/data_vg/gluster_openldap-config"
ssh 192.168.100.12 "lvremove -y --force /dev/data_vg/gluster_openldap-data"
ssh 192.168.100.12 "lvremove -y --force /dev/data_vg/gluster_openldap-run"
ssh 192.168.100.13 "lvremove -y --force /dev/data_vg/gluster_openldap-config"
ssh 192.168.100.13 "lvremove -y --force /dev/data_vg/gluster_openldap-data"
ssh 192.168.100.13 "lvremove -y --force /dev/data_vg/gluster_openldap-run"
